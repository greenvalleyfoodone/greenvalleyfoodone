    ...
    <>
      ...
      <div>
        ...
        <dl className="space-y-6 text-valley-ink/80">
          <div>
            <dt className="font-mono text-xs uppercase tracking-wide text-valley-ink/50 mb-1">
              Address
            </dt>
      ...
      <div className="rounded-sm overflow-hidden border border-valley-ink/10 min-h-[320px]">
        <iframe
          title="Green Valley Coffee One location map"
          src="https://www.google.com/maps?q=Green+Valley+Coffee+One,+4XRH%2B3GM,+Santhamaguluru,+Andhra+Pradesh+522603&output=embed"
